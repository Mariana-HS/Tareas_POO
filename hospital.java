...
public Paciente obtenerPacientePorId(String idPaciente){
    ...
    public void mostrarMedico() {
        if (listaMedicos.size() == 0) {
            System.out.println("No hay usuarios.medicos registrados");
        }
    ...
    public void mostrarCitasPaciente(String idPaciente) {

        List<Consulta> citasPaciente = new ArrayList<>();

        for (Consulta consulta : this.listaConsultas) {
            if (consulta.getPaciente().getId().equals(idPaciente)) {
                citasPaciente.add(consulta);
            }
        }
        ...
        if (citasPaciente.isEmpty()) {
            ...
            System.out.println("\nCitas realizadas:");
            for (Consulta consulta : citasPaciente) {
                System.out.println(consulta.mostrarDatos());
            }
        }
    }

    public void mostrarPacientesPorMedico(String idMedico) {
        List<Consulta> consultas = this.getListaConsultasPorMedico(idMedico);
        if (consultas.isEmpty()) {
            System.out.println("No hay usuarios.pacientes asignados para el médico con ID " + idMedico);
        } else {
            System.out.println("Pacientes que atenderá el médico con ID " + idMedico + ":");
    ...
    public void mostrarConsultasPorMedico(String idMedico) {
        List<Consulta> consultas = this.getListaConsultasPorMedico(idMedico);
        if (consultas.isEmpty()) {
            System.out.println("No hay consultas registradas para el médico con ID " + idMedico);
        } else {
            System.out.println("Consultas del médico con ID " + idMedico + ":");
            for (Consulta consulta : consultas) {
                System.out.println(consulta.mostrarDatos());
            }
        }
    ...
    public List<Consulta> getListaConsultasPorMedico(String idMedico) {
