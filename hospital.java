...
public class Hospital {
    ...
    public ArrayList<Admin> listaAdministrador= new ArrayList<>();
    public ArrayList<Consultorio> listaConsultorios = new ArrayList<>();
    public ArrayList<Consulta> listaConsultas = new ArrayList<>();
    private ValidadorHospital validador = new ValidadorHospital();

    public Hospital(){
        Admin administrador= new Admin("admin12","Juan", "Medina",LocalDate.now(),"445564565","hula*", "aaaaa", 1212,20000);
